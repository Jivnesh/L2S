...
dir=Dep_ws
train=Dep_ws/ptb3.0-stanford.gold.cpos.train.conll		
dev=Dep_ws/ptb3.0-stanford.gold.cpos.test.conll
TAGS=Dep_ws/ptb_tags
...
# --holdout_off -f $dir/dep.model --search_history_length 3 --search_no_caching -b 25 \
# --root_label 45 --num_label 45 --nn 5 --ftrl --progress 100
...
echo "#################################################################"
python2 ./L2S/parse_test_result.py $dev.vw $dir/dep.test.predictions $TAGS > $dir/dep.test.parse
