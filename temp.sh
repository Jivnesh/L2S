...
train=./models/Dep_san_temp/ud_pos_ner_dp_train_san
dev=./models/Dep_san_temp/ud_pos_ner_dp_test_san
dev_org=./data/ud_pos_ner_dp_test_san
TAGS=./data/san_tags
declare -i dimension=20
start_time=`date +%s`
touch $dir/train_log.txt
touch $dir/result_log.txt
echo "#################################################################"
...
# --early_terminate 3
vw  -d $train.vw -k -c --search_rollin mix_per_roll --ignore v --dictionary v:embedding_size_$dimension.dict --dictionary_path $dir \
...
vw -d $dev.vw -t -i $dir/dep.model -p $dir/dep.test.predictions --progress 10 --ignore v --dictionary v:embedding_size_$dimension.dict --dictionary_path $dir
# $dir/dep.model 
echo "#################################################################"
